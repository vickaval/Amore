	...
	public class Categoria {
		...
		public boolean agregarCategoria() {
			 ...
			 public boolean editarCategoria() {//no anda
				 int indice=Integer.parseInt(JOptionPane.showInputDialog(null, "ingrese el id de la categoria a editar"));
				 String nombre=JOptionPane.showInputDialog(null, "ingrese el nuevo nombre de la categoria");
