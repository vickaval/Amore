...
public class eliminarAlmacenista extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					eliminarAlmacenista frame = new eliminarAlmacenista();
	 ...
	 * Create the frame.
	 */
	public eliminarAlmacenista() {
		setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		setBounds(100, 100, 327, 177);
		setTitle("Eliminar Almacenista");
		...
		JLabel lblNewLabel = new JLabel("Ingresa el id del almacenista: ");
