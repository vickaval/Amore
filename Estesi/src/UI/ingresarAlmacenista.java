...
public class ingresarAlmacenista extends JFrame{
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ingresarAlmacenista frame = new ingresarAlmacenista();
	 ...
	 * Create the frame.
	 */
	public ingresarAlmacenista() {
		setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		setBounds(100, 100, 376, 441);
		setTitle("Ingresar Almacenista");
		...
		textField_7.setBounds(190, 260, 134, 20);
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				String idDepo=textField_7.getText();
				...
				int idDepo2 = Integer.parseInt(idDepo);
				 ...
				 String sql ="INSERT INTO `almacenista`( `nombre`,`apellido`, `telefono`, `contraseña`, `sueldo`, `nombreArea`, `aniosAntiguedad`, `idDepo`)"
					 		+ "VALUES(?,?,?,?,?,?,?,?)";
				    	try {
		...
		btnNewButton.setBounds(106, 323, 134, 41);
		...
		JLabel lblNewLabel_7 = new JLabel("Ingresar idDepo: ");
		lblNewLabel_7.setBounds(48, 260, 141, 14);
