...
public class ingresarOperario extends JFrame{
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ingresarOperario frame = new ingresarOperario();
	 ...
	 * Create the frame.
	 */
	public ingresarOperario() {
		setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		setBounds(100, 100, 376, 441);
		setTitle("Ingresar Operario");
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				String turno=textField_7.getText();
				...
				double sueldo2 = Double.parseDouble(sueldo);
				 ...
				 String sql ="INSERT INTO `operario`( `nombre`,`apellido`, `telefono`, `contraseña`, `sueldo`, `nombreArea`, `aniosAntiguedad`, `turno`)"
					 		+ "VALUES(?,?,?,?,?,?,?,?)";
				    	try {
		...
		JLabel lblNewLabel_7 = new JLabel("Ingresar turno: ");
