		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				int idDepo2=Integer.parseInt(idDepo);
				 ...
				 String sql ="INSERT INTO `materiaprima`(`nombre`, `procedencia`, `precio`, `stockDisponible`, `idDepo`)"
					 		+ "VALUES(?,?,?,?,?)";
				    	try {
				    		PreparedStatement stmt = conexion.prepareStatement(sql);
				    		
							stmt.setString(1, nombre);
							stmt.setString(2, procedencia);
							stmt.setDouble(3, precio2);
							stmt.setInt(4, stock2);
							stmt.setInt(5, idDepo2);
							stmt.executeUpdate();
							stmt.close();
							conexion.close();
