...
public class Almacenista extends Usuario {
		...
		*/
		...
		public boolean iniciarSesion(String usuario, String contrasenia) {
		    ...
		    if (usuario.equals(getUsuario()) &&contrasenia.equals(getContraseña())) {
		        //System.out.println("Inicio de sesiï¿½n exitoso.");
		        return true;
		    } else {
		        System.out.println("Inicio de sesionn fallido. Por favor verifique su usuario, contrasenia y permiso.");
		        return false;
		    }
		}
