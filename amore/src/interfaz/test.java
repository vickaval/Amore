...
public class test {
	...
	public static void main(String[] args) {
		...
		MateriaPrima materia1 = new MateriaPrima(1001, "Tomate", "Espa�a", 1.50, 500);
		MateriaPrima materia2 = new MateriaPrima(1002, "Cebolla", "M�xico", 0.75, 300);
		...
		Salsa salsaBolo�esa = new Salsa(6, "Salsa Bolo�esa", "Salsa", 3.50, 10);
		...
		depo.agregarProducto(salsaBolo�esa);
	    ...
	    if(seleccion == 0) {
	    	...
	    	if (al.iniciarSesion(al.getUsuario(), al.getContrase�a())) { // Si el inicio de sesi�n es exitoso
	    		int eleccion;
	    	 	do {
	    	    ...
	    	    eleccion = JOptionPane.showOptionDialog(null, "�Qu� acci�n desea realizar?", "Men� principal", JOptionPane.DEFAULT_OPTION, JOptionPane.QUESTION_MESSAGE, null, opciones, opciones[0]);
	    	    switch (eleccion) {
	    	        case 0:	    	        		
	    	    		 ArrayList<MateriaPrima> materias = prod.getListaMPs();
	    	             String mensaje = "Listado de Materias Primas: \n\n";
	    	             for (MateriaPrima mp : materias) {
	    	             	mensaje += "C�digo: " + mp.getCodigoMp() + " - " + "Nombre: " + mp.getNombre() +  " - " + "Stock: " + mp.getStockDisponible() + "\n";
	    	             }
	    	        ...
	    	        case 1:    	    		
	    	             ...
	    	             for (Producto produ : productos) {
	    	             	mensaje1 += "C�digo: " + produ.getIdProducto() + " - " + "Nombre: " + produ.getNombre() +  " - " 
