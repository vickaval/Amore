...
public class test {
	...
	public static void main(String[] args) {
		...
		Salsa salsaTomate2 = new Salsa(4, "Salsaaaaa de Tomate", "Salsa", 1.50, 16);
		...
		Salsa salsaBoloniesa = new Salsa(6, "Salsa Bolo�esa", "Salsa", 3.50, 10);
	    ...
	    if(seleccion == 0) {
	    	...
	    	if (al.iniciarSesion(al.getUsuario(), al.getContrasenia())) { // Si el inicio de sesi�n es exitoso
	    		int eleccion;
	    	 	do {
